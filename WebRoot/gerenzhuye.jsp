<%@ page language="java" import="java.util.*,com.jhdx.bean.*" pageEncoding="utf-8"%>
...
function getData(offset,size,id){
	$.ajax({
        ...
        success : function(data) {
            ...
            "</ul>"+
            "<ul class=\"details\">"+
              "<a href=\"javascript:void(0);\" style=\"float:right\" onclick=\"DeleteArt("+data[i].articleId+")\">删除</a>"+
...
$.ajax({
type : "POST",
url : "articleServlet?action=del",
dataType : "text",
data : {"articleid":id},
success : function(data){
debugger;
var s = parseInt("<%=((User)session.getAttribute("user")).getId()%>");
laqu(s);
jichu();
},
error : function (XMLHttpRequest, textStatus, errorThrown) {
...
<body onload="laqu(${sessionScope.user.id})">
<%--  <c:choose>
...
<div id="mainbody">
  <div class="info">
    ...
    <div class="card">
      <h1>我的名片</h1>
      <p>网名：${sessionScope.user.nickname }</p>
      <p>职业：Web前端设计师、网页设计</p>
      <p>电话：13662012345</p>
      <p>Email：dancesmiling@qq.com</p>
      <ul class="linkmore">
        <li><a href="Publish.jsp" class="talk" title="发表博文"></a></li>
        <li><a href="/" class="address" title="联系地址"></a></li>
        <li><a href="/" class="email" title="给我写信"></a></li>
        <li><a href="/" class="photos" title="生活照片"></a></li>
        <li><a href="cang.jsp" class="heart" title="收藏"></a></li>
      </ul>
    </div>
  </div>
  <!--info end-->
